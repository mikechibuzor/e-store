<template>
  <nav class="ml-8">
      <div class="hamburger-button xl:hidden z-30 absolute left-5 top-7" @click="toggleMenu">
        <!-- icon menu -->
        <svg v-if="menuOpen" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg">
...
.menu-overlay ul{
    box-shadow: 2px 0px 12px rgba(0,0,0,.1);
}
</style>